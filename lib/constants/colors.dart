...
const Color amber = Color(0xFFF8C715);
const Color white = Color(0xFFFFFFFF);
const Color purple = Color(0xFF693DA1);
const Color red = Color(0xFFDA4040);
const Color lblue = Color(0xFFADD8E6);
const Color blue100 = Color(0xFF64B5F6);
const Color fblue = Color(0xFF2074F0);
const Color nblue = Color( 0xFF4682B4);
const Color dblue = Color(0xFF0F1C3F);
